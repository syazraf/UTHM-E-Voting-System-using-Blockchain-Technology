        ...
        <nav class="col-md-2 sidebar">
            <div class="sidebar-sticky pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="#" onclick="loadPage('student_dashboard_content.php')">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="loadPage('view_candidates.php')">View Candidates</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="loadPage('vote.php')">Vote</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="loadPage('settings_student.php')">Settings</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    function loadPage(page) {
        ...
        fetch(page)
            ...
            .then(html => {
                ...
                if (page === 'student_dashboard_content.php') {
                    fetchLiveResults();
