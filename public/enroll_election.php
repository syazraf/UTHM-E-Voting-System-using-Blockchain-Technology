...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("UPDATE candidates SET manifesto = ?, status = 'pending' WHERE matric_number = ?");
...
$stmt = $connection->prepare("SELECT manifesto FROM candidates WHERE matric_number = ?");
